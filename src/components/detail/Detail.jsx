    ...
    <div className='detailpost'>
        <div className="detailpostWrapper">
            ...
            <h1 className="detailpostTitle">
                ...
                <i className="detailpostIcon fa-solid fa-pen-to-square"></i>
                <i className="detailpostIcon fa-solid fa-trash"></i>
                </div>
            </h1>
            <div className="detailpostInfo">
                <span className='detailpostAuthor'>Author: <b>Kisnak</b></span>
